...
export class LoginComponent  implements OnInit{
  ...
  constructor( private formBuilder: FormBuilder, private authService: AuthService, private router: Router, private userService: UserService, private companyAdministratorService: CompanyAdministratorService){
  }
  ngOnInit(): void {
